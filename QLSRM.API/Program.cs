...
builder.Services.AddScoped<BLComboTypes>();
builder.Services.AddScoped<BLCommune>();
builder.Services.AddScoped<BLCustomer>();
builder.Services.AddScoped<BLCustomerLog>();
builder.Services.AddScoped<BLDistrict>();
builder.Services.AddScoped<BLProduct>();
builder.Services.AddScoped<BLProvince>();
